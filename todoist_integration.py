...
def create_todoist_task(content, section_id=TODOIST_SECTION_ID, project_id=TODOIST_PROJECT_ID, due_string="today"):
    ...
    try:
        task = api.add_task(content=content, section_id=section_id, project_id=project_id, due_string=due_string)
